...
export const TRACKED_PATHS = [
  ...
  // v1.228 — คิวมิกซ์ 0 แถวใน 18 วันหลัง deploy และเราตอบไม่ได้ว่าเพราะอะไร:
  // หน้านี้ไม่เคยถูกเก็บ เลยแยกไม่ออกระหว่าง "ไม่รู้ว่ามี" (ทางเข้าอยู่ใน More)
  // กับ "เข้าไปแล้วไม่ขอ" — ซึ่งเป็นคำถามที่ไฟล์นี้สร้างมาตอบพอดี
  '/mix',
  '/my-bookings',
  '/admin',
] as const
